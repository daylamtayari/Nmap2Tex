...
\definecolor{NoneVuln}{RGB}{157,195,231}
\definecolor{LowVuln}{RGB}{255,255,103}
\definecolor{MedVuln}{RGB}{255,192,0}
\definecolor{HighVuln}{RGB}{255,102,0}
\definecolor{CritVuln}{RGB}{254,0,0}
...
\newcommand{\host}[4]{
    #1 & #2 & #3 &
    \begin{tabular}{ l | l }
        \textbf{Port:}\hspace{1cm} & \textbf{Service:}\hspace{4cm} \\
